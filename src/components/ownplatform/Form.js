          ...
          <h2 className="title">Own Platform</h2>     
            <table className="table" >
              <tr>
                ...
                <td>: {ownplatformData.pitch} </td>  
                <td><label >Acceleration X</label></td>
                <td>: {ownplatformData.accelerationX} </td> 
                <td><label >Barometric Pressure</label></td>
                <td>: {ownplatformData.barometricPressure}</td>
              </tr>
              ...
              <tr >
                ...
                <td>: {ownplatformData.roll}</td>
                <td><label >Acceleration Y</label></td>
                <td>: {ownplatformData.accelerationY}</td>
                <td><label >Air Temperature</label></td>
                <td>: {ownplatformData.airTemperature}</td>  
              </tr>        
              ...
              <tr>
                ...
                <td>: {ownplatformData.yaw} </td>
                <td><label >Acceleration Z</label></td>
                <td>: {ownplatformData.accelerationZ} </td>
